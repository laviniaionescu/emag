This is a school project led by our teacher that demonstrates a web application built with Flask. The app includes a user login feature and retrieves product data from a PostgreSQL database. 
